...
the permissions boundary `arn:aws:iam::281614735122:policy/hackathon-boundary`.
...
aws iam create-role \
  ...
  --permissions-boundary arn:aws:iam::281614735122:policy/hackathon-boundary \
...
aws lambda create-function --function-name my-function ... \
  --role arn:aws:iam::281614735122:role/my-app-role
```
